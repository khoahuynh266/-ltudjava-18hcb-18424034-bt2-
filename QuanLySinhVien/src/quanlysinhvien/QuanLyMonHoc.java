...
//            JOptionPane.showMessageDialog(null, "!!! Chưa Có Bảng Điểm");
    ...
    private void addDataForComboBoxClass() {
        ...
        List<ThoiKhoaBieu> listTKB = ThoiKhoaBieuDAO.getListThoiKhoaBieu();
        if (listTKB.size() > 0) {
            for (ThoiKhoaBieu tkb : listTKB) {
                String TenLopMH = tkb.getTenLop() + "-" + tkb.getMaMonHoc();
                comboboxModel.addElement(TenLopMH);
            }
            cbLop_MonHoc.setModel(comboboxModel);
        } else {
            cbLop_MonHoc.setModel(new javax.swing.DefaultComboBoxModel(new String[]{}));
        }
    }
